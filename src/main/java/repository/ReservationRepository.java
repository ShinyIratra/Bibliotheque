...
public class ReservationRepository {
    ...
    public void insertReservation(int idAdherent, int idExemplaire) {
        String sql = "INSERT INTO Reservation (date_reservation, date_reserver, id_adherent, id_exemplaire) VALUES (NOW(), NOW() + INTERVAL '7 days', ?, ?)";
        jdbcTemplate.update(sql, idAdherent, idExemplaire);
    }
